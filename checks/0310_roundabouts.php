...
query("
	...
	WHERE b.admin_level IN ('1', '2') AND
		b.name IN ('Anguilla', 'Antigua and Barbuda', 'Australia',
		'Bahamas', 'Bangladesh', 'Barbados', 'Bhutan', 'Botswana', 'Brunei', 'Cayman
		Islands', 'Cyprus', 'Dominica', 'Falkland Islands', 'Fiji', 'Grenada',
		'Guernsey', 'Guyana', 'Hong Kong', 'India', 'Indonesia', 'Ireland', 'Isle of
		Man', 'Jamaica', 'Japan', 'Jersey', 'Kenya', 'Kiribati', 'Lesotho', 'Macau',
		'Malawi', 'Malaysia', 'Maldives', 'Malta', 'Mauritius', 'Montserrat',
		'Mozambique', 'Namibia', 'Nauru', 'Nepal', 'New Zealand', 'Pakistan', 'Papua New
		Guinea', 'Papua Niugini', 'Saint Kitts and Nevis', 'Saint Lucia', 'Saint Vincent
		and the Grenadines', 'Seychelles', 'Singapore', 'Solomon Islands', 'South
		Africa', 'Sri Lanka', 'Suriname', 'Swaziland', 'Tanzania', 'Thailand', 'Tonga',
		'Trinidad and Tobago', 'Tuvalu', 'Uganda', 'United Kingdom', 'British Virgin
		Islands', 'U.S. Virgin Islands', 'Virgin Islands', 'Zambia', 'Zimbabwe')
	AND ST_Within(ST_PointFromText ('POINT(' || r.Cx || ' ' || r.Cy || ')',
4326), b.geom)
...
query("
	...
	WHERE ST_Within(
		...
		ST_GeomFromText ('POLYGON((-200375 6242596, -222639 6372180,
		322827 6676758, 389618 7079082, 0 8821377, -2738459 7268959, -200375 6242596))',
4326)
	)
", $db1);
...
// lat/lon: -17 10, -40 10, -40 40, -20 40, -15.5 41.75, -1.9 41.75, -0.9 41, 2.76 40.95, 3.9 41.9, 3.9 41.1, 4.2 40.7, 3.8 39.9, 3.37 39.5, 3.55 38.1, 4.43 36.78, 4.43 36, 4.6 35.86, 4.56 34.4, 3.73 33.53, 3.47 30.9, 2.41 30.72, 2.06 31.29, 0.79 29.97, -1.41 29.58, -1.45 30.06, -1.1 30.41, -1.67 30.8, -2.41 30.81, -2.46 30.54, -2.95 30.46, -3.16 30.81, -4.52 29.67, -6.27 29.45, -8.28 30.72, -8.58 28.94, -9.32 28.46, -10.75 28.63, -11.61 28.28, -12.43 29.02, -12.47 29.46, -12.13 29.78, -13.37 29.78, -13.41 29.03, -11.96 27.36, -11.65 25.29, -11.22 25.29, -11.44 24.32, -11.1 24.32, -10.92 23.97, -13.03 23.93, -13.07 21.95, -16.25 21.95, -17.69 23.4, -18.07 20.94, -17.86 18.83, -17.44 18.35, -17.48 13.91, -17.06 13.38, -17 10
 query("
	...
	WHERE ST_Within(
		ST_PointFromText ('POINT(' || r.Cx || ' ' || r.Cy || ')', 4326),
		ST_GeomFromText ('POLYGON((1113195 -1908339, 1113195 -4838471,
			4452780 -4838471, 4452780 -2258424, 4647589 -1735479, 4647589 -210130, 4564099
			-99521, 4558533 305305, 4664287 431578, 4575231 431578, 4530703 464834, 4441648
			420495, 4397120 372853, 4241273 392793, 4094331 490339, 4007502 490339, 3991917
			509196, 3829390 504759, 3732543 412738, 3439772 383931, 3419735 266564, 3483187
			227833, 3336245 87356, 3292831 -155926, 3346264 -160350, 3385226 -121639,
			3428640 -184686, 3429754 -266564, 3399697 -272097, 3390792 -326340, 3429754
			-349594, 3302849 -500322, 3278359 -694707, 3419735 -918801, 3221586 -952341,
			3168153 -1035188, 3187077 -1195803, 3148115 -1292762, 3230492 -1385493, 3279472
			-1390024, 3315094 -1351534, 3315094 -1492161, 3231605 -1496709, 3045701
			-1332307, 2815270 -1297279, 2815270 -1248756, 2707290 -1273572, 2707290
			-1235228, 2668328 -1214947, 2663875 -1453532, 2443463 -1458074, 2443463
			-1821742, 2604876 -1988318, 2331030 -2032497, 2096146 -2008070, 2042713
			-1959305, 1548454 -1963944, 1489455 -1915282,
...
query("
	...
	WHERE ST_Within(
		ST_PointFromText ('POINT(' || r.Cx || ' ' || r.Cy || ')', 4326),
		ST_GeomFromText ('POLYGON((-6660245 927743, -6760433 828371,
			-6714792 773750, -6814979 725865, -6831677 654671, -6762659 575788, -6676943
			561354, -6693641 499213, -6629076 433794, -6666924 259923, -6546699 130487,
			-6354117 218981, -6223873 204598, -6237231 273204, -6114780 282059, -6074705
			256603, -6007913 392793, -6064686 485903, -6056893 561354, -5985649 686920,
			-6660245 927743))', 4326)
		)
", $db1);
...
query("
	...
	WHERE ST_Within(
		ST_PointFromText ('POINT(' || r.Cx || ' ' || r.Cy || ')', 4326),
		ST_GeomFromText ('POLYGON((6812753 2757862, 6925186 3029714,
			7030939 3059413, 7045411 3127710, 6991977 3137673, 6991977 3264082, 6849488
			3337220, 6771565 3457913, 6961921 3400601, 7378256 3463020, 7431689 3634029,
			7534103 3662547, 7720007 3721091, 7740044 3881285, 7817968 3915712, 7784572
			3998228, 7905910 4003573, 7969362 4178676, 7925948 4276875, 8048399 4378750,
			8381244 4403679, 8684033 4178676, 8825409 3814052, 8733014 3798289, 8781995
			3662547, 9041369 3482189, 9090350 3530883, 9623570 3215130, 9887397 3225157,
			9907435 3132691, 9995377 3243977, 10269223 3195098, 10543069 3385361, 10626559
			3363802, 10700029 3409499, 10749010 3277922, 10833613 3255282, 10789085 3153877,
			10584257 3034660, 10577578 2944677, 10530824 2877250, 10545295 2865023, 10481843
			2716659, 10391674 2862579, 10371637 2521808, 10308185 2490751, 10308185 2409796,
			10269223 2419301, 10281468 2285529, 10199092 363992, 7671026 363992, 6812753
			2757862))', 4326)
		)
", $db1);
...
query("
	...
	WHERE ST_Within(
		ST_PointFromText ('POINT(' || r.Cx || ' ' || r.Cy || ')', 4326),
		ST_GeomFromText ('POLYGON((10875914 1019501, 10998366 1167671,
			10993913 1182297, 11091874 1311963, 11032875 1452397, 11035101 1545651, 10932687
			1666698, 10934914 1701064, 10971649 1720560, 10981668 1851724, 10834726 2087273,
			10883707 2091942, 10898178 2218428, 11025082 2252536, 11138628 2303229, 11194288
			2271382, 11179816 2209029, 11272212 2198462, 11243269 1965104, 11367946 2040645,
			11463681 2016209, 11507096 2069775, 11580567 2045303, 11664056 1953507, 11674075
			1824047, 11745319 1751557, 11719716 1586697, 11475926 1593544, 11396889 1501258,
			11455889 1287117, 11367946 1201432, 11679641 798267, 13264831 857379, 13324943
			331877, 14393610 620217, 15782877 388362, 18414470 -651336, 17378086 -2109460,
			20009678 -4105604, 20009678 -6766432, 9907435 -6766432, 9907435 1678148,
			10575352 1563886, 10875914 1019501))', 4326)
		)
", $db1);
