...
$error_types[150]['class']='error';
$error_types[140]['description']="Streets tagged as one-way must not be dead-ended (where should all the cars pile at the end of the road?). Nodes where just one-way streets begin (or end) cannot be reached (escaped from). Please note that motorways and motorway_links are considered one-way implicitly, so this check applies.";
...
$error_types[190]['class']='error';
$error_types[190]['description']="Streets that graphically intersect need a common node that represents the crossing. The only exception are intersections on different layers (eg. bridges or tunnels). Intersections of streets with other objects like waterways or riverbanks should be avoided";
...
$error_types[190]['subtype'][195]='cycleway-cycleway';
$error_types[190]['subtype'][196]='highway-cycleway';
$error_types[190]['subtype'][197]='cycleway-waterway';
$error_types[190]['subtype'][198]='cycleway-riverbank';


$error_types[200]['name']='overlapping ways';
$error_types[200]['enabled']=true;
$error_types[200]['source']='';
$error_types[200]['class']='error';
...
$error_types[380]['description']="&apos;sports&apos; is a non-physical tag that needs to be bound to some physical structure\nlike for example a leisure-item or an amenity. Ways tagged with &apos;sports&apos; solely will be invisible on the map";
